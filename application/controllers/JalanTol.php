...
class JalanTol extends CI_Controller
{
    ...
    public function dataspasial()
    {
        ...
        $this->load->view('admin/dataspasial', $data);
    ...
    public function Form_new()
    {
        ...
        $this->load->view('templates/navbar');
        $this->load->view('templates/sidebar');
        $this->load->view('admin/form_data_teknik', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function datateknik()
    {
        ...
        $this->load->view('templates/navbar');
        $this->load->view('templates/sidebar');
        $this->load->view('admin/data_teknik', $data);
        $this->load->view('templates/footer');
    }
    ...
    {
        if ($id != 0) {
            $data['identifikasi'] = $this->db->get_where('identifikasi', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['data_teknik_1'] = $this->db->get_where('data_teknik_1', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['data_teknik_2'] = $this->db->get_where('data_teknik_2', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['data_teknik_2_median'] = $this->db->get_where('data_teknik_2_median', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['data_teknik_3'] = $this->db->get_where('data_teknik_3', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['data_teknik_4'] = $this->db->get_where('data_teknik_4', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['data_teknik_5'] = $this->db->get_where('data_teknik_5', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['data_lainnya'] = $this->db->get_where('data_lainnya', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['lhr'] = $this->db->get_where('lhr', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['geometrik'] = $this->db->get_where('geometrik', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
            $data['data_lingkungan_jalan'] = $this->db->get_where('data_lingkungan_jalan', ['ruas_km' => $id, 'jenis_page' => "ledger"])->result_array();
        } else {
            $data['identifikasi'] = $this->db->get_where('identifikasi', ['jenis_page' => "ledger"])->result_array();
            $data['data_teknik_1'] = $this->db->get_where('data_teknik_1', ['jenis_page' => "ledger"])->result_array();
            $data['data_teknik_2'] = $this->db->get_where('data_teknik_2', ['jenis_page' => "ledger"])->result_array();
            $data['data_teknik_2_median'] = $this->db->get_where('data_teknik_2_median', ['jenis_page' => "ledger"])->result_array();
            $data['data_teknik_3'] = $this->db->get_where('data_teknik_3', ['jenis_page' => "ledger"])->result_array();
            $data['data_teknik_4'] = $this->db->get_where('data_teknik_4', ['jenis_page' => "ledger"])->result_array();
            $data['data_teknik_5'] = $this->db->get_where('data_teknik_5', ['jenis_page' => "ledger"])->result_array();
            $data['data_lainnya'] = $this->db->get_where('data_lainnya', ['jenis_page' => "ledger"])->result_array();
            $data['lhr'] = $this->db->get_where('lhr', ['jenis_page' => "ledger"])->result_array();
            $data['geometrik'] = $this->db->get_where('geometrik', ['jenis_page' => "ledger"])->result_array();
            $data['data_lingkungan_jalan'] = $this->db->get_where('data_lingkungan_jalan', ['jenis_page' => "ledger"])->result_array();
        }
        ...
        $this->pdf->filename = "Pdf_datateknik.pdf";
