        ...
        <nav class="mt-2">
            ...
            with font-awesome or any other icon font library -->
                ...
                <?php if ($this->session->userdata('level') == 2) { ?>
                    ...
                    <li class="nav-item has-treeview<?= $this->uri->segment(1) == 'dataumum' || $this->uri->segment(1) == 'dataspasial' || $this->uri->segment(1) == 'datateknik' || $this->uri->segment(1) == 'Form_new' ? ' menu-open' : '' ?>">
                    ...
                    <li class="nav-item has-treeview<?= $this->uri->segment(1) == 'dataumum_ramp' ||  $this->uri->segment(1) == 'dataspasial_ramp' || $this->uri->segment(1) == 'datateknik_ramp' || $this->uri->segment(1) == "Form_new_ramp" ? ' menu-open' : '' ?>">
                        <a href="#" class="nav-link<?= $this->uri->segment(1) == 'dataumum_ramp' || $this->uri->segment(1) == 'dataspasial_ramp' || $this->uri->segment(1) == 'datateknik_ramp' || $this->uri->segment(1) == "Form_new_ramp" ? ' active' : '' ?>">
                            <i class="nav-icon fas fa-list"></i>
                            <p>
                                RAMP
                                <i class="right fas fa-angle-left"></i>
