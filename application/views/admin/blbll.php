                            ...
                            <div class="form-group row">
                                <div class="col-md-12 col-sm-12 ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 ">
                                            <select class="form-control" id="ruas_km">
                                                <option value="">Pilih Ruas</option>
                                                <?php $get = $this->db->get_where('identifikasi', ['jenis_page' => "ledger"])->result_array(); ?>
                                                <?php foreach ($get as $g) { ?>
                                                    <option value="<?= $g['ruas_km'] ?>"><?= $g['ruas_km'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <a href="javascript:void(0)" class="btn btn-info download_pdf"> <i class="fa fa-download"></i> PDF</a>
                                        <a href="javascript:void(0)" class="btn btn-success print_data ml-2"> <i class="fa fa-print"></i> Print</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="x_panel">
                                        <div class="x_title">
                                            ...
                                            <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active click_tab" id="ident-tab" data-id="Identifikasi" data-toggle="tab" href="#ident" role="tab" aria-controls="ident" aria-selected="true">Identifikasi</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link click_tab" id="teknik1-tab" data-toggle="tab" data-id="RUMIJA" href="#teknik1" role="tab" aria-controls="teknik1" aria-selected="true">Data Teknik 1</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link click_tab" id="teknik2-tab" data-toggle="tab" data-id="Konstruksi" href="#teknik2" role="tab" aria-controls="teknik2" aria-selected="false">Data Teknik 2</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link click_tab" id="teknik3-tab" data-toggle="tab" data-id="Bagian Perlengkapan" href="#teknik3" role="tab" aria-controls="teknik3" aria-selected="false">Data Teknik 3</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link click_tab" id="teknik4-tab" data-toggle="tab" data-id="Perlengkapan" href="#teknik4" role="tab" aria-controls="teknik4" aria-selected="false">Data Teknik 4</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link click_tab" id="teknik5-tab" data-toggle="tab" data-id="Utilitas" href="#teknik5" role="tab" aria-controls="teknik5" aria-selected="false">Data Teknik 5</a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="ident" role="tabpanel" aria-labelledby="ident_tab">
                                                    ...
                                                    <table class="table table-bordered" id="mytableidentifikasi" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                    ...
                                                    <!-- <br><br>
                                                    <table class="table table-bordered" id="mytablelokasi" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                                <th>TAHUN</th>
                                                                <th>PROVINSI</th>
                                                ...
                                                <div class="tab-pane fade" id="teknik1" role="tabpanel" aria-labelledby="teknik1-tab">
                                                    ...
                                                    <table class="table table-bordered" id="mytabledatateknik1" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                                <th scope="row" rowspan="2">RUAS</th>
                                                ...
                                                <div class="tab-pane fade" id="teknik2" role="tabpanel" aria-labelledby="teknik2-tab">
                                                    <table class="table table-bordered" id="mytabledatateknik2" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                    ...
                                                    <br><br>
                                                    <table class="table table-bordered" id="mytabledatateknik2median" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                ...
                                                <div class="tab-pane fade" id="teknik3" role="tabpanel" aria-labelledby="teknik3-tab">
                                                    ...
                                                    <table class="table table-bordered" id="mytabledatateknik3" style="width: 100%;">
                                                        <thead>
                                                ...
                                                <div class="tab-pane fade" id="teknik4" role="tabpanel" aria-labelledby="teknik4-tab">
                                                    ...
                                                    <table class="table table-bordered" id="mytabledatateknik4" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                ...
                                                <div class="tab-pane fade" id="teknik5" role="tabpanel" aria-labelledby="teknik5-tab">
                                                    ...
                                                    <table class="table table-bordered" id="mytabledatateknik5" style="width: 100%;">
                                                        <thead>
                                ...
                                <div class="col-md-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            ...
                                            <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active click_tab" id="datalainnya-tab" data-toggle="tab" data-id="Tambahan" href="#datalainnya" role="tab" aria-controls="datalainnya" aria-selected="false">Data Lainnya</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link click_tab" id="lintasanharian-tab" data-toggle="tab" data-id="LHR" href="#lintasanharian" role="tab" aria-controls="lintasanharian" aria-selected="true">Lintasan Harian</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link click_tab" id="geometrik-tab" data-toggle="tab" data-id="Geometrik Jalan" href="#geometrik" role="tab" aria-controls="geometrik" aria-selected="false">Data Geometrik</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link click_tab" id="lingkunganjalan-tab" data-toggle="tab" data-id="Tambahan" href="#lingkunganjalan" role="tab" aria-controls="lingkunganjalan" aria-selected="false">Data Lingkungan Jalan</a>
                                                </li>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="datalainnya" role="tabpanel" aria-labelledby="datalainnya-tab">
                                                    ...
                                                    <table class="table table-bordered" id="mytabledatalainnya" style="width: 100%;">
                                                        <thead>
                                                ...
                                                <div class="tab-pane fade" id="lintasanharian" role="tabpanel" aria-labelledby="lintasanharian-tab">
                                                    <table class="table table-bordered" id="mytabledatalintasan" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                                <th style="width: 100%;" scope="row" rowspan="2">RUAS</th>
                                                ...
                                                <div class="tab-pane fade" id="geometrik" role="tabpanel" aria-labelledby="geometrik-tab">
                                                    <table class="table table-bordered" id="mytabledatageometrik" style="width: 100%;">
                                                ...
                                                <div class="tab-pane fade" id="lingkunganjalan" role="tabpanel" aria-labelledby="lingkunganjalan-tab">
                                                    <table class="table table-bordered" id="mytabledatalingkungan" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                                <th style="width: 100%;" scope="row" rowspan="2">RUAS</th>
