    ...
    $.ajax({
        ...
        success: (data) => {
            ...
            geojsonPath.forEach((el) => {
                var settings = {
                    "url": "http://localhost:8080/geoserver/rams/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=rams%3A00_ADMINISTRATIF&maxFeatures=50&outputFormat=application%2Fjson"+el+"&outputFormat=application%2Fjson",
                    "method": "GET",
                };
