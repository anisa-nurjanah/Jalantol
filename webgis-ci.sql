...
CREATE TABLE `m_spasial` (
  ...
  `nama_atribut` varchar(10) NOT NULL,
...
(001,'administratif', 'administratif.geojson', '#009900'),
(003, 'lapis permukaan', 'lapis permukaan.geojson','#0de70d'),
(004, 'gorong gorong', 'gorong gorong.geojson', '#880000'),
(005, 'guardrail', 'guardrail.geojson', '#000099'),
(006, 'listrik bawah tanah', 'listrik dalam tanah.geojson','#DD9900');
...
--
ALTER TABLE `m_spasial`
  MODIFY `id_atribut` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
